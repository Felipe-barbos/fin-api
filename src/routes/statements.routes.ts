...
import { ToTransferController } from '../modules/statements/useCases/toTransfer/ToTransferController';
...
const toTransferController = new ToTransferController();
...
statementRouter.post('/transfer/:user_id', toTransferController.execute);
